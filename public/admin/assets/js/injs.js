...
var crudApp = new function () {
    ...
    this.myBooks = [
        { NO: '1', Nama: 'Noor Afifah',  Jurusan: 'Informatika', NIM: '2018103703111099', Status: 'aktif' },
        { NO: '2', Nama: 'Asep', Jurusan: 'Sipil', NIM: '2018103703111099', Status: 'aktif' },
        { NO: '3', Nama: 'Hamba Allah', Jurusan: 'Elektro', NIM: '2018103703111099', Status: 'aktif' }
    ]

    this.category = ['Informatika', 'Sipil', 'Mesin', 'Elektro','Industri'];
    this.col = [];
