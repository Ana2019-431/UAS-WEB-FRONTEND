<!DOCTYPE html>
	...
	<head>
		...
		<!-- Favicon-->
		<link rel="shortcut icon" href="<?php echo e(asset('website/img/icon-umm.ico')); ?>">
		<!-- Author Meta -->
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title><?php echo e(config('sekolah.tittle')); ?></title>

		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			<!--
			CSS
			============================================= -->
			<link rel="stylesheet" href="<?php echo e(asset('website/css/linearicons.css')); ?>">
		  ...
		  <header id="header" id="home">
	  			...
	  			<div class="container">
			  		<div class="row">
			  			<div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
			  				<a href="tel:+62 31 8921 591"><span class="lnr lnr-phone-handset"></span> <span class="text"><?php echo e(config('sekolah.telpon')); ?></span></a>
			  				<a href="mailt:smamda@smamda.sch.id"><span class="lnr lnr-envelope"></span> <span class="text"><?php echo e(config('sekolah.email')); ?></span></a>			
			  			</div>
			  		</div>			  					
	  			</div>
			</div>
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="/"><img src="<?php echo e(asset('website/img/logo-umm.png')); ?>" width="150" height="80" alt="" title="" /></a>
			      </div>	    		
		    	</div>
		    </div>
		  </header><!-- #header -->
			...
			<script src="<?php echo e(asset('website/js/vendor/jquery-2.2.4.min.js')); ?>"></script>
			...
			<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDWdGA-ndsHMtR5-cdZrc5SHtfKKBG5Bfg&callback=initMap"></script>
  			<script src="<?php echo e(asset('website/js/easing.min.js')); ?>"></script>			
			<script src="<?php echo e(asset('website/js/hoverIntent.js')); ?>"></script>
			<script src="<?php echo e(asset('website/js/superfish.min.js')); ?>"></script>	
    		...
    		<script src="<?php echo e(asset('website/js/jquery.tabs.min.js')); ?>"></script>						
			<script src="<?php echo e(asset('website/js/jquery.nice-select.min.js')); ?>"></script>	
	...
	</html><?php /**PATH C:\xampps\htdocs\tescrud\resources\views/layouts/laysite.blade.php ENDPATH**/ ?>